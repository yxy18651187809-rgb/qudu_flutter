...
class AppColors {
  ...
  static const Color ipBook = Color(0xFFFF8A65);         // 珊瑚橙 - 书颜色
  static const Color ipStroke = Color(0xFFA5C487);        // 灰绿 - 描边色
  static const Color gradientEnd = Color(0xFF4CAF50);     // 翠绿 - 背景渐变终点
}
