...
class _ProfileView extends StatelessWidget {
            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: AppSpacing.lg),
                  _buildLearningReportSection(context, state),
                  const SizedBox(height: AppSpacing.lg),
  ...
  Widget _buildProfileHeader(BuildContext ctx, ProfileState state) {
    return Row(
      children: [
        Container(
          width: 60,
        ...
        IconButton(
          onPressed: () =>
              Navigator.pushNamed(ctx, '/children'),
  ...
  Widget _buildChildSelector(BuildContext ctx, ProfileState state) {
  ...
  /// 学习统计卡片（暂时硬编码，后续接入 LearningRepository）
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            ...
            children: [
              _ProfileStatItem(
                  value: '47', label: '识字量', color: AppColors.primary),
              _ProfileStatItem(
                  value: '3', label: '已读绘本', color: AppColors.accent),
              _ProfileStatItem(
                  value: 'L1',
                  label: '当前级别',
  ...
  Widget _buildLearningReportSection(
      BuildContext ctx, ProfileState state) {
    if (state.children.isEmpty) return const SizedBox.shrink();
    return Container(
      decoration: BoxDecoration(
        color: AppColors.surface,
        ...
        children: [
          ...
          _MenuRow(
            ...
            onTap: () {
              ...
              ctx.go('/learning-report?childId=${child.id}$nameParam');
            },
          ),
        ],
      ),
          ...
          _MenuRow(
            ...
            onTap: () {
              ...
              if (parentId.isNotEmpty) {
                ctx.go('/parent-monitoring/$parentId');
              }
            },
          ),
        ],
  ...
  // === 退出登录 / 注销（保留在 Widget 层，涉及 Dialog） ===
...
// =============================================================================
// 子组件（与原 ProfilePage 完全相同，从 StatefulWidget 中提取）
// =============================================================================
          ...
          children: [
            ...
            Expanded(
              child: Text(
                title,
                style: TextStyle(
                    fontSize: 14, color: titleColor ?? AppColors.textPrimary),
              ),
            ),
